...
JoinCustomerandStepTrainer_node167625698452 = Join.apply(
    frame1=AccelerometerTrusted_node1,
    frame2=StepTrainerTrusted_node1676402494135,
    keys1=["timestamp"],
    keys2=["sensorreadingtime"],
    transformation_ctx="JoinCustomerandStepTrainer_node167625698452",
)

# Script generated for node Drop Fields
DropFields_node1676402760786 = DropFields.apply(
    frame=JoinCustomerandStepTrainer_node167625698452,
    paths=["user"],
    transformation_ctx="DropFields_node1676402760786",
)
