...
StepTrainerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-thanhtv35/projects/step_trainer/landing/"],
        "recurse": True,
    },
...
StepTrainerTrusted_node1676524568952 = glueContext.write_dynamic_frame.from_catalog(
    ...
    transformation_ctx="StepTrainerTrusted_node1676524568952",
)
